...
Public Enum SpellFailedReason
{
    ...
    SPELL_FAILED_CHEST_IN_USE = 0xB,                                // 0x00B
    SPELL_FAILED_DONT_REPORT = 0xC,                                 // 0x00C
    SPELL_FAILED_EQUIPPED_ITEM = 0xD,                               // 0x00D
    SPELL_FAILED_EQUIPPED_ITEM_CLASS = 0xE,                         // 0x00E
    SPELL_FAILED_ERROR = 0xF,                                       // 0x00F
    SPELL_FAILED_FIZZLE = 0x10,                                     // 0x010
    SPELL_FAILED_HUNGER_SATIATED = 0x11,                            // 0x011
    SPELL_FAILED_HIGHLEVEL = 0x12,                                  // 0x012
    SPELL_FAILED_INTERRUPTED = 0x13,                                // 0x013
    SPELL_FAILED_INTERRUPTED_COMBAT = 0x14,                         // 0x014
    SPELL_FAILED_ITEM_ALREADY_ENCHANTED = 0x15,                     // 0x015
    SPELL_FAILED_ITEM_NOT_FOUND = 0x16,                             // 0x016
    SPELL_FAILED_ITEM_NOT_READY = 0x17,                             // 0x017
    SPELL_FAILED_LEVEL_REQUIREMENT = 0x18,                          // 0x018
    SPELL_FAILED_LINE_OF_SIGHT = 0x19,                              // 0x019
    SPELL_FAILED_LOWLEVEL = 0x1A,                                   // 0x01A
    SPELL_FAILED_LOW_CASTLEVEL = 0x1B,                              // 0x01B
    SPELL_FAILED_MAINHAND_EMPTY = 0x1C,                             // 0x01C
    SPELL_FAILED_MOVING = 0x1D,                                     // 0x01D
    SPELL_FAILED_NEED_AMMO = 0x1E,                                  // 0x01E
    SPELL_FAILED_NEED_AMMO_POUCH = 0x1F,                            // 0x01F
    SPELL_FAILED_NEED_EXOTIC_AMMO = 0x20,                           // 0x020
    SPELL_FAILED_NOPATH = 0x21,                                     // 0x021
    SPELL_FAILED_NOT_STANDING = 0x22,                               // 0x022
    SPELL_FAILED_NOT_UNSHEATHED = 0x23,                             // 0x023
    SPELL_FAILED_NOT_BEHIND = 0x24,                                 // 0x024
    SPELL_FAILED_NOT_FISHABLE = 0x25,                               // 0x025
    SPELL_FAILED_NOT_HERE = 0x26,                                   // 0x026
    SPELL_FAILED_NOT_INFRONT = 0x27,                                // 0x027
    SPELL_FAILED_NOT_KNOWN = 0x28,                                  // 0x028
    SPELL_FAILED_NOT_MOUNTED = 0x29,                                // 0x029
    SPELL_FAILED_NOT_READY = 0x2A,                                  // 0x02A
    SPELL_FAILED_NOT_SHAPESHIFT = 0x2B,                             // 0x02B
    SPELL_FAILED_NOT_TRADEABLE = 0x2C,                              // 0x02C
    SPELL_FAILED_NOT_TRADING = 0x2D,                                // 0x02D
    SPELL_FAILED_NO_AMMO = 0x2E,                                    // 0x02E
    ...
    SPELL_FAILED_AUTOTRACK_INTERRUPTED = 0x61,                      // 0x061
    SPELL_FAILED_CANT_CAST_ON_TAPPED = 0x62,                        // 0x062
    SPELL_FAILED_ITEM_GONE = 0x63,                                  // 0x063
    SPELL_FAILED_UNKNOWN = 0x64,                                    // 0x064
