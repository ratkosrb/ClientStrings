...
Public Enum OPCODES
{
    ...
    CMSG_PET_CAST_SPELL_OBSOLETE=378,                               // 0x17A
    ...
    CMSG_PLAYER_MACRO=483,                                          // 0x1E3
    SMSG_PLAYER_MACRO=484,                                          // 0x1E4
    CMSG_GHOST=485,                                                 // 0x1E5
    CMSG_GM_INVIS=486,                                              // 0x1E6
    CMSG_SCREENSHOT=487,                                            // 0x1E7
    ...
    MSG_ADD_DYNAMIC_TARGET=496,                                     // 0x1F0
    ...
    SMSG_RAID_MEMBER_STATS=639,                                     // 0x27F
    ...
    CMSG_GMTICKETSYSTEM_TOGGLE=658,                                 // 0x292
    CMSG_CANCEL_GROWTH_AURA=659,                                    // 0x293
    SMSG_CANCEL_AUTO_REPEAT=660,                                    // 0x294
    SMSG_STANDSTATE_CHANGE_ACK=661,                                 // 0x295
    SMSG_LOOT_ALL_PASSED=662,                                       // 0x296
    SMSG_LOOT_ROLL_WON=663,                                         // 0x297
    CMSG_LOOT_ROLL=664,                                             // 0x298
    SMSG_LOOT_START_ROLL=665,                                       // 0x299
    SMSG_LOOT_ROLL=666,                                             // 0x29A
    CMSG_LOOT_MASTER_GIVE=667,                                      // 0x29B
    SMSG_LOOT_MASTER_LIST=668,                                      // 0x29C
    SMSG_SET_FORCED_REACTIONS=669,                                  // 0x29D
    SMSG_SPELL_FAILED_OTHER=670,                                    // 0x29E
    SMSG_GAMEOBJECT_RESET_STATE=671,                                // 0x29F
    CMSG_REPAIR_ITEM=672,                                           // 0x2A0
    SMSG_CHAT_PLAYER_NOT_FOUND=673,                                 // 0x2A1
    MSG_TALENT_WIPE_CONFIRM=674,                                    // 0x2A2
    SMSG_SUMMON_REQUEST=675,                                        // 0x2A3
    CMSG_SUMMON_RESPONSE=676,                                       // 0x2A4
    MSG_MOVE_TOGGLE_GRAVITY_CHEAT=677,                              // 0x2A5
    SMSG_MONSTER_MOVE_TRANSPORT=678,                                // 0x2A6
    SMSG_PET_BROKEN=679,                                            // 0x2A7
    MSG_MOVE_FEATHER_FALL=680,                                      // 0x2A8
    MSG_MOVE_WATER_WALK=681,                                        // 0x2A9
    CMSG_SERVER_BROADCAST=682,                                      // 0x2AA
    CMSG_SELF_RES=683,                                              // 0x2AB
    SMSG_FEIGN_DEATH_RESISTED=684,                                  // 0x2AC
    CMSG_RUN_SCRIPT=685,                                            // 0x2AD
    SMSG_SCRIPT_MESSAGE=686,                                        // 0x2AE
    NUM_MSG_TYPES=687,                                              // 0x2AF
}
