...
Public Enum ChatMsg
{
    ...
    CHAT_MSG_GUILD = 0x2,                                           // 0x002
    CHAT_MSG_OFFICER = 0x3,                                         // 0x003
    CHAT_MSG_YELL = 0x4,                                            // 0x004
    CHAT_MSG_WHISPER = 0x5,                                         // 0x005
    CHAT_MSG_WHISPER_INFORM = 0x6,                                  // 0x006
    CHAT_MSG_EMOTE = 0x7,                                           // 0x007
    CHAT_MSG_TEXT_EMOTE = 0x8,                                      // 0x008
    ...
    CHAT_MSG_MONEY = 0x1A,                                          // 0x01A
    CHAT_MSG_RAID_LEADER = 0x1B,                                    // 0x01B
    CHAT_MSG_RAID_WARNING = 0x1C,                                   // 0x01C
}
