...
Public Enum EUnitFields
{
    ...
    UNIT_FIELD_MOD_DAMAGE_DONE = EObjectFields.OBJECT_END + 0x94,                 // 0x09A - Size: 6 - Type: INT - Flags: PRIVATE
    UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE = EObjectFields.OBJECT_END + 0x9A,      // 0x0A0 - Size: 6 - Type: INT - Flags: PRIVATE
    UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE = EObjectFields.OBJECT_END + 0xA0,      // 0x0A6 - Size: 6 - Type: INT - Flags: PRIVATE
    UNIT_FIELD_RESISTANCEITEMMODS = EObjectFields.OBJECT_END + 0xA6,              // 0x0AC - Size: 6 - Type: INT - Flags: PRIVATE
    UINT_FIELD_BYTES_1 = EObjectFields.OBJECT_END + 0xAC,                         // 0x0B2 - Size: 1 - Type: BYTES - Flags: PUBLIC
    UNIT_FIELD_PETNUMBER = EObjectFields.OBJECT_END + 0xAD,                       // 0x0B3 - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_FIELD_PET_NAME_TIMESTAMP = EObjectFields.OBJECT_END + 0xAE,              // 0x0B4 - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_FIELD_PETEXPERIENCE = EObjectFields.OBJECT_END + 0xAF,                   // 0x0B5 - Size: 1 - Type: INT - Flags: OWNER_ONLY
    UNIT_FIELD_PETNEXTLEVELEXP = EObjectFields.OBJECT_END + 0xB0,                 // 0x0B6 - Size: 1 - Type: INT - Flags: OWNER_ONLY
    UNIT_DYNAMIC_FLAGS = EObjectFields.OBJECT_END + 0xB1,                         // 0x0B7 - Size: 1 - Type: INT - Flags: DYNAMIC
    UNIT_EMOTE_STATE = EObjectFields.OBJECT_END + 0xB2,                           // 0x0B8 - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_CHANNEL_SPELL = EObjectFields.OBJECT_END + 0xB3,                         // 0x0B9 - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_MOD_CAST_SPEED = EObjectFields.OBJECT_END + 0xB4,                        // 0x0BA - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_CREATED_BY_SPELL = EObjectFields.OBJECT_END + 0xB5,                      // 0x0BB - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_NPC_FLAGS = EObjectFields.OBJECT_END + 0xB6,                             // 0x0BC - Size: 1 - Type: INT - Flags: PUBLIC
    UNIT_FIELD_BYTES_2 = EObjectFields.OBJECT_END + 0xB7,                         // 0x0BD - Size: 1 - Type: BYTES - Flags: PRIVATE
    UNIT_FIELD_ATTACKPOWER = EObjectFields.OBJECT_END + 0xB8,                     // 0x0BE - Size: 1 - Type: INT - Flags: PRIVATE
    UNIT_FIELD_PADDING = EObjectFields.OBJECT_END + 0xB9,                         // 0x0BF - Size: 1 - Type: INT - Flags: NONE
    UNIT_END = EObjectFields.OBJECT_END + 0xBA                                    // 0x0C0
}
Public Enum EPlayerFields
{
    PLAYER_FIELD_INV_SLOT_1 = EUnitFields.UNIT_END + 0x0,                         // 0x0BA - Size: 46 - Type: GUID - Flags: PUBLIC
    PLAYER_FIELD_PACK_SLOT_1 = EUnitFields.UNIT_END + 0x2E,                       // 0x0E8 - Size: 32 - Type: GUID - Flags: PRIVATE + UNK2
    PLAYER_FIELD_BANK_SLOT_1 = EUnitFields.UNIT_END + 0x4E,                       // 0x108 - Size: 48 - Type: GUID - Flags: PRIVATE
    PLAYER_FIELD_BANKBAG_SLOT_1 = EUnitFields.UNIT_END + 0x7E,                    // 0x138 - Size: 12 - Type: GUID - Flags: PRIVATE
    PLAYER_SELECTION = EUnitFields.UNIT_END + 0x8A,                               // 0x144 - Size: 2 - Type: GUID - Flags: PUBLIC
    PLAYER_FARSIGHT = EUnitFields.UNIT_END + 0x8C,                                // 0x146 - Size: 2 - Type: GUID - Flags: PRIVATE
    PLAYER_DUEL_ARBITER = EUnitFields.UNIT_END + 0x8E,                            // 0x148 - Size: 2 - Type: GUID - Flags: PUBLIC
    PLAYER_FIELD_NUM_INV_SLOTS = EUnitFields.UNIT_END + 0x90,                     // 0x14A - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_GUILDID = EUnitFields.UNIT_END + 0x91,                                 // 0x14B - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_GUILDRANK = EUnitFields.UNIT_END + 0x92,                               // 0x14C - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_BYTES = EUnitFields.UNIT_END + 0x93,                                   // 0x14D - Size: 1 - Type: BYTES - Flags: PUBLIC
    PLAYER_XP = EUnitFields.UNIT_END + 0x94,                                      // 0x14E - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_NEXT_LEVEL_XP = EUnitFields.UNIT_END + 0x95,                           // 0x14F - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_SKILL_INFO_1_1 = EUnitFields.UNIT_END + 0x96,                          // 0x150 - Size: 192 - Type: TWO_SHORT - Flags: PRIVATE
    PLAYER_BYTES_2 = EUnitFields.UNIT_END + 0x156,                                // 0x210 - Size: 1 - Type: BYTES - Flags: PUBLIC
    PLAYER_QUEST_LOG_1_1 = EUnitFields.UNIT_END + 0x157,                          // 0x211 - Size: 80 - Type: INT - Flags: PRIVATE
    PLAYER_CHARACTER_POINTS1 = EUnitFields.UNIT_END + 0x1A7,                      // 0x261 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_CHARACTER_POINTS2 = EUnitFields.UNIT_END + 0x1A8,                      // 0x262 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_TRACK_CREATURES = EUnitFields.UNIT_END + 0x1A9,                        // 0x263 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_TRACK_RESOURCES = EUnitFields.UNIT_END + 0x1AA,                        // 0x264 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_CHAT_FILTERS = EUnitFields.UNIT_END + 0x1AB,                           // 0x265 - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_DUEL_TEAM = EUnitFields.UNIT_END + 0x1AC,                              // 0x266 - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_BLOCK_PERCENTAGE = EUnitFields.UNIT_END + 0x1AD,                       // 0x267 - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_DODGE_PERCENTAGE = EUnitFields.UNIT_END + 0x1AE,                       // 0x268 - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_PARRY_PERCENTAGE = EUnitFields.UNIT_END + 0x1AF,                       // 0x269 - Size: 1 - Type: FLOAT - Flags: PRIVATE
    PLAYER_BASE_MANA = EUnitFields.UNIT_END + 0x1B0,                              // 0x26A - Size: 1 - Type: INT - Flags: PRIVATE
    PLAYER_GUILD_TIMESTAMP = EUnitFields.UNIT_END + 0x1B1,                        // 0x26B - Size: 1 - Type: INT - Flags: PUBLIC
    PLAYER_EXPLORED_ZONES_1 = EUnitFields.UNIT_END + 0x1B2,                       // 0x26C - Size: 32 - Type: BYTES - Flags: PRIVATE
    PLAYER_END = EUnitFields.UNIT_END + 0x1D2                                     // 0x28C
}
